...
function preload(){
 ...
 restartimg = loadImage("PLAY2.PNG")
 pauseimg=  loadImage("pause1.png")
...
function setup() {
 ...
 mute.position(windowWidth-520,windowHeight/8-35)
 mute.size(50,50)
 mute.mouseClicked(muteButton)

  //mute=createSprite()
  // skip_intro=createSprite(width - 100,height - 70)
